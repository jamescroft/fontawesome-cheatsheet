//YAML to Javascript object dump of Font Awesome v4.0.3

var ArrayOfIcons = { icons: 
   [ { name: 'Glass',
       id: 'glass',
       unicode: 'f000',
       created: 1,
       filter: [ 'martini', 'drink', 'bar', 'alcohol' ],
     ...
     { name: 'comment',
       ...
       unicode: 'f075',
       created: 1,
       filter: [ 'speech', 'notification', 'note' ],
       categories: [ 'Web Application Icons' ] },
     { name: 'magnet',
       id: 'magnet',
       unicode: 'f076',
     ...
     { name: 'Thumbs Up Outlined',
       ...
       unicode: 'f087',
       created: 1,
       filter: [ 'like', 'approve', 'favorite', 'agree' ],
       categories: [ 'Web Application Icons' ] },
     { name: 'Thumbs Down Outlined',
       id: 'thumbs-o-down',
       unicode: 'f088',
       created: 1,
       filter: [ 'dislike', 'disapprove', 'disagree' ],
       categories: [ 'Web Application Icons' ] },
     { name: 'star-half',
       id: 'star-half',
       unicode: 'f089',
     ...
     { name: 'Arrows Alt',
       ...
       unicode: 'f0b2',
       created: 2,
       filter: [ 'expand', 'enlarge', 'bigger', 'move', 'reorder', 'resize' ],
     ...
     { name: 'Building Outlined',
       ...
       unicode: 'f0f7',
       created: 3,
       filter: [ 'work', 'business', 'apartment', 'office' ],
       categories: [ 'Web Application Icons' ] },
     ...
     { name: 'medkit',
       ...
       unicode: 'f0fa',
       created: 3,
       filter: [ 'first aid', 'firstaid', 'help', 'support' ],
       categories: [ 'Medical Icons' ] },
     { name: 'fighter-jet',
       id: 'fighter-jet',
       unicode: 'f0fb',
     ...
     { name: 'beer',
       ...
       unicode: 'f0fc',
       created: 3,
       filter: [ 'alcohol', 'stein', 'drink', 'mug', 'bar' ],
       categories: [ 'Web Application Icons' ] },
     { name: 'H Square',
       id: 'h-square',
       unicode: 'f0fd',
     ...
     { name: 'thumbs-up',
       ...
       unicode: 'f164',
       created: 3.2,
       filter: [ 'like', 'favorite', 'approve', 'agree' ],
       categories: [ 'Web Application Icons' ] },
     { name: 'thumbs-down',
       id: 'thumbs-down',
       unicode: 'f165',
